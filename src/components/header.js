...
export default () => (
//2parties ditinctes la premiere pour requeté et l'autre pour directement renvoyé un rendu statique via graphql
  <StaticQuery
    query = {graphql `
      query {
        site {
    ...
    render = { data =>
      ...
      <header className={styles.container}>
        ...
        <HomeButton to='/' text={data.site.siteMetadata.title}/>
          <SocialButton site="github" username="woodstock13"></SocialButton>
